...
function UIScene:mousereleased(x, y, button, istouch, presses)
  for _, element in pairs(self.elements) do
    if element.active and element.mousereleased then
      element:mousereleased(x, y, button, istouch, presses)
    end
  end
end
